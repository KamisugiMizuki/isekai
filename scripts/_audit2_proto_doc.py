...
LIMITS = {k: getattr(version, k) for k in ("MAX_FRAME_BYTES", "HANDSHAKE_TIMEOUT_S", "PROTOCOL_ERROR_LIMIT", "DEFAULT_MAX_TEXT_LEN", "DEFAULT_MAX_PARTS", "DEFAULT_MAX_CONNECTIONS", "DEFAULT_MAX_QUEUED_INBOUND", "DEFAULT_RATE_LIMIT_MSGS", "DEFAULT_RATE_LIMIT_WINDOW_S", "DEFAULT_MAX_ATTACHMENTS", "DEFAULT_MAX_ATTACHMENT_BYTES")} | {  # ⑤ 常量名 → 代码取值
