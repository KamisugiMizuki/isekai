...
- 普通用户界面设计 v1.0（已定稿；U1–U4 已实施、U5 部分实施——启动与联络、时间线管理、尝试世界变化、单文件全量备份、创建向导（世界设定 + 角色卡）、开发目录迁移、辅助写作工作区、跑团核心与规则登记、发行件组装与数据根，实施进度与已知边界见文末）：[`docs/user-interface/README.md`](docs/user-interface/README.md)
